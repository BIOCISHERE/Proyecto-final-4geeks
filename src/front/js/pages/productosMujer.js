                ...
                <div className="row">
                    ...
                    <div className="col-9 border border-primary container-fluid">
                        <div className="row row-cols-1 row-cols-md-3 g-4">
                            <div className={isPolera ? ("col") : ("col d-none")}>
                                <div className="card">
                            ...
                            <div className={isPoleron ? ("col") : ("col d-none")}>
                                <div className="card">
                                    <img src="..." className="card-img-top img-fluid" alt="..." />
                                    <div className="card-body">
                                        <h5 className="card-title">Poleron/Sweaters</h5>
                                        <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={isPantalon ? ("col") : ("col d-none")}>
                                <div className="card">
                                    <img src="..." className="card-img-top img-fluid" alt="..." />
                                    <div className="card-body">
                            ...
                            <div className={isJeans ? ("col") : ("col d-none")}>
                                <div className="card">
                                    <img src="..." className="card-img-top img-fluid" alt="..." />
                                    <div className="card-body">
                            ...
                            <div className={isFalda ? ("col") : ("col d-none")}>
                                <div className="card">
                                    <img src="..." className="card-img-top img-fluid" alt="..." />
                                    <div className="card-body">
                                        <h5 className="card-title">Faldas/Vestidos</h5>
                                        <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                    </div>
                                </div>
                            </div>
